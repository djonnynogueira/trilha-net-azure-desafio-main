...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // TODO: Chamar o método SaveChanges do _context para salvar no Banco SQL - OK

        var tableClient = GetTableClient();
        var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao, funcionario.Departamento, Guid.NewGuid().ToString());

        // TODO: Chamar o método UpsertEntity para salvar no Azure Table - OK
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // TODO: As propriedades estão incompletas - OK

        // TODO: Chamar o método de Update do _context.Funcionarios para salvar no Banco SQL - OK
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // TODO: Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL - OK
